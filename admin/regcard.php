...
if (isset($_POST['generateRegCard_pdf'])) {
    ...
    function generateRegCardePDF($backgroundImage,$IssueDate,$SerialNumber, $CertificateHolderName, $FathersName, $MothersName, $CourseName, $Institutename, $heldForm, $HeldformTo, $Grade, $RollNumber, $RegistrationNumber, $filename, $profileImage) {
        ...
        $pdf->Cell(0, 0, "Reg No:  ..................   Seassion: .......................to.......................", 0, 1, 'L');
        ...
        // Set text position
        $rollNumberDot1X = 78; // X-coordinate
    ...
    $backgroundImage = 'https://app.shiacomputer.com/wp-content/uploads/2023/07/Registraion-Card.jpg';
    ...
    $filename = 'SCTC-REG-'.$RegistrationNumber.'.pdf';
    generateRegCardePDF($backgroundImage,$IssueDate,$SerialNumber, $CertificateHolderName, $FathersName, $MothersName, $CourseName, $Institutename, $heldForm, $HeldformTo, $Grade, $RollNumber, $RegistrationNumber, $filename, $profileImage);
}
?>