...
<?php
                            ...
                            if (isset($shiacomputeroption['AdminDueStudentList'])) {
                                ...
                                if ($get_adminDueLink_id) {
                                    $get_adminDueLink_link = get_permalink($get_adminDueLink_id); // Get the permalink of the selected page
                                }
                            }
                            $location = $get_adminDueLink_link; 
                                            ...
                                            if ($dueAmount != 0.00) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button type="button" class="btn-primary btn-sm" data-toggle="modal" data-target="#exampleModalCenter<?php echo get_the_ID() ?>">Pay Due</button>
                                                                ...
                                                                <div class="modal-content rounded-0">
                                                                    <div class="modal-body p-4 px-5">
                                                                        ...
                                                                        <div class="main-content text-center">
                                                                            ...
                                                                            <p class="mb-4">Total Due Aount : <?php $payAmount2 = get_post_meta(get_the_ID(), 'student_due_amount_register', true); echo $payAmount2 ?></p>
                                                                            <form method="post">
                                                                                ...
                                                                                <input type="hidden" type="text" name="IDno" required value="<?php $IdNo = get_post_meta(get_the_ID(), 'student_certificate_serial_number', true); echo $IdNo; ?>">

                                                                                <label for="custom_field_value">New Student Pay Amount:</label>
                                                                                <input type="number" class="form-control text-center" name="custom_field_value" required min="1" max="<?php $custom_student_Due_register2 = get_post_meta(get_the_ID(), 'student_due_amount_register', true); echo $custom_student_Due_register2; ?>" >
